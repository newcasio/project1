...
In order to increase their profits and influence, groups battle one another for territorial control. In some cases they possess greater coercive force and governance capabilities than the often weak or corrupt local governments. In 2006, in partnership with the United States, former Mexican President Felipe Calderon launched an initiative to combat the cartels with military force. This significantly escalated violence and claimed thousands of lives, including civilians.', parties: 'Drug cartels, Mexican Government', image: 'http://thefederalist.com/wp-content/uploads/2014/01/cartel.jpg', lat: 25.54, lng:-103.41
...
The situation in Ukraine escalated into an international crisis, putting the United States and the European Union (EU) at odds with Russia, in July 2014, when a Malaysian Airlines flight was shot down over Ukrainian airspace, killing all 298 onboard, by what Dutch air accident investigators concluded in October 2015 was a Russian-built surface-to-air missile. In September 2016, investigators said that the missile system was provided by Russia, determining it was moved in to eastern Ukraine and then back to Russian territory following the downing of the airplane.', parties: 'Ukraine, Russia', image: 'http://mapofeurope.com/wp-content/uploads/2014/03/Ukraine-Crimea-Russia.jpg', lat:45.47, lng: 34.49
